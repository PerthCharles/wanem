...
?>
		<div align=center style="color: #000000; background-color: #488ac7; border: thin solid #000000; width: 100%">
		<table border="0" width="100%" colspan=10>
		  <tr>
			<td width="100%">
...
//Call the function to process 'tc -s qd', 'tc class show dev (int)' and 'tc filter show dev (int)' to get
//the number of netem rule sets in use for the selected interface and the values of each rule set.

//Call the get_current_values function with the correct flags set based if the add or the delete rule set
//button were clicked.
