...
/*   Description  :                                                         */
/*                                                                          */
/*   Modifications: Hemanta Kumar Kalita                                    */
/*   Date         : Nov 2007                                              */
/****************************************************************************/
/*                                                                          */
...
?>
		<div style="color: #000000; background-color: #ffffff; border: thin solid #000000; width:<?echo $width?>; align: center;">
			<p align="center"><b>The following commands would be executed:</b></p>
			<p><?=$displayCmd?></p>
		</div>
<?
	}
	for ($i=1; $i<=count($interfaces);++$i) {
		...
		//echo "sym[$i-1] =", $sym[$i-1];
                if($advflag == 1)
                   {?>
                       <center>
                       <div style="color: #000000; background-color: #aaccff; border: thin solid #000000; width: 90%; align: center">
...
<?
		...
		if ($advanced[$i-1]!=1) {
		    //There is an interface with none or one rule set so the apply settings button should be set
		    //to visible
			$showButton=true;
?>
	
	<div style="color: #000000; background-color: #aaccff; border: thin solid #000000; width:100%; align: center">
